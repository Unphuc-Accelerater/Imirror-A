  ...
  return (
    <div className="bg-white flex flex-col items-center w-full min-h-screen">
      <div className="bg-[linear-gradient(136deg,rgba(219,234,254,1)_11%,rgba(202,225,254,1)_43%,rgba(252,231,243,1)_100%)] w-[381px] min-h-screen relative overflow-hidden">
        ...
        <div className="absolute w-full h-[60px] top-0 left-0 flex items-center justify-center pt-4">
          <motion.button
            className="absolute top-6 left-6 w-9 h-[15px]"
            whileTap={{ scale: 0.9 }}
        ...
        {/* Success Card */}
        <motion.div
          className="w-[350px] mx-auto bg-white rounded-[20px] shadow-lg pt-8 pb-6 px-6 mt-[80px] relative flex flex-col items-center text-center"
