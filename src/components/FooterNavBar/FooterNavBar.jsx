        ...
        >
          ...
          <motion.span 
            className={`text-xs font-medium mt-1 transition-colors duration-200 ${
              active ? 'text-[#74a4ee]' : 'text-gray-500'
            }`}
    ...
    >
      <div className="bg-white/95 backdrop-blur-xl border-t border-gray-100 shadow-2xl">
        <div className="flex items-center justify-around px-4 py-2 max-w-md mx-auto relative">
          ...
          >
            <motion.button
              className="w-16 h-16 bg-gradient-to-r from-[#74a4ee] to-[#9783d3] rounded-2xl shadow-xl flex items-center justify-center -mt-6 border-4 border-white"
